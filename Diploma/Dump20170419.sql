...
--
-- Table structure for table `rebuke`
--

DROP TABLE IF EXISTS `rebuke`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `rebuke` (
  `re_rank` int(11) NOT NULL,
...
--
-- Dumping data for table `rebuke`
--

LOCK TABLES `rebuke` WRITE;
/*!40000 ALTER TABLE `rebuke` DISABLE KEYS */;
INSERT INTO `rebuke` VALUES (1,'university'),(2,'faculty'),(3,'hostel');
/*!40000 ALTER TABLE `rebuke` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `room` VALUES ('1011a',5,5,10),('142a',5,5,1),('147a',5,5,1),('222b',5,5,2),('253b',5,5,2),('516b',5,5,5),('712a',5,5,7);
...
-- Dump completed on 2017-04-19 18:36:46
